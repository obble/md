    ...
    MODUI_CLASS_COLORS                  = {
        ['DRUID']       = {r = 255/255, g = 110/255, b = 063/255, colourStr = 'ffff6e3f'},
        ['HUNTER']      = {r = 140/255, g = 220/255, b = 105/255, colourStr = 'ff8cdc69'},
        ['MAGE']        = {r = 000/255, g = 194/255, b = 255/255, colourStr = 'ff00c2ff'},
        ['PALADIN']     = {r = 255/255, g = 095/255, b = 168/255, colourStr = 'ffff5fa8'},
        ['PRIEST']      = {r = 255/255, g = 255/255, b = 255/255, colourStr = 'ffffffff'},
        ['ROGUE']       = {r = 255/255, g = 232/255, b = 000/255, colourStr = 'ffffe800'},
        ['SHAMAN']      = {r = 050/255, g = 111/255, b = 255/255, colourStr = 'ff326fff'},
        ['WARLOCK']     = {r = 140/255, g = 118/255, b = 238/255, colourStr = 'ff8c76ee'},
        ['WARRIOR']     = {r = 214/255, g = 148/255, b = 110/255, colourStr = 'ffd6946e'}
    }
    ...
    MailFrame.Material:SetTexture[[Interface\AddOns\md\art\quest\QuestBG.tga]]
    ...
    for _, v in pairs({
        ...
        v.Material:SetTexture[[Interface\AddOns\md\art\quest\QuestBG.tga]]
    ...
    QuestLogFrame.Material:SetTexture[[Interface\AddOns\md\art\quest\QuestBG.tga]]
    ...
    SpellBookFrame.Material:SetTexture[[Interface\AddOns\md\art\quest\QuestBG.tga]]
    ...
    local OnShow = function()
        H.GroupLootFrame_OnShow()
        for _, v in pairs(
                {
                    _G[this:GetName()..'Corner'],
                    _G[this:GetName()..'Decoration']
                }
            ) do
            v:SetVertexColor(
                var.r, var.g, var.b
    ...
    e:SetScript('OnEvent', function()
        for _, v in pairs(MODUI_COLOURELEMENTS_FOR_UI) do
            v:SetVertexColor(var.r, var.g, var.b)
        end
        for _, v in pairs(MODUI_COLOURELEMENTS_BORDER_FOR_UI) do
            v:SetBackdropBorderColor(var.r, var.g, var.b)
        end
    end)
